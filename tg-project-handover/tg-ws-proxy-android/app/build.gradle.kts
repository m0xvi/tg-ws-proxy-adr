...
android {
    ...
    signingConfigs {
        getByName("debug") {
            // Один и тот же debug-ключ хранится в репозитории, чтобы APK,
            // собранные локально и в GitHub Actions, имели идентичную подпись
            // и взаимно обновлялись без удаления приложения.
