...
class ProxyService : Service() {
    ...
    private var lastPrivateRelayEnabled: Boolean = false
    private var lastPrivateRelayDomain: String = ""
    private var lastPrivateRelayToken: String = ""
    ...
    companion object {
        ...
        const val EXTRA_PRIVATE_RELAY_ENABLED = "EXTRA_PRIVATE_RELAY_ENABLED"
        const val EXTRA_PRIVATE_RELAY_DOMAIN = "EXTRA_PRIVATE_RELAY_DOMAIN"
        const val EXTRA_PRIVATE_RELAY_TOKEN = "EXTRA_PRIVATE_RELAY_TOKEN"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            ACTION_START -> {
                ...
                val privateRelayEnabled = intent.getBooleanExtra(EXTRA_PRIVATE_RELAY_ENABLED, false)
                val privateRelayDomain = intent.getStringExtra(EXTRA_PRIVATE_RELAY_DOMAIN) ?: ""
                val privateRelayToken = intent.getStringExtra(EXTRA_PRIVATE_RELAY_TOKEN) ?: ""
                val secretKey = intent.getStringExtra(EXTRA_SECRET_KEY) ?: ""
                startProxy(
                    bindIp, port, ips, poolSize, cfEnabled, cfPriority, cfDomain,
                    privateRelayEnabled, privateRelayDomain, privateRelayToken, secretKey
                )
            }
            ACTION_STOP -> {
                stopProxy()
            ...
            null -> {
                ...
                if (lastPort > 0 && lastSecretKey.isNotEmpty()) {
                    ...
                    startProxy(
                        lastBindIp, lastPort, lastIps, lastPoolSize,
                        lastCfEnabled, lastCfPriority, lastCfDomain,
                        lastPrivateRelayEnabled, lastPrivateRelayDomain, lastPrivateRelayToken,
                        lastSecretKey
                    )
                } else {
                    stopSelf()
    ...
    private fun startProxy(bindIp: String, port: Int, ips: String, poolSize: Int = 4,
                           ...
                           cfDomain: String = "", privateRelayEnabled: Boolean = false,
                           privateRelayDomain: String = "", privateRelayToken: String = "",
                           secretKey: String = "") {
        ...
        lastPrivateRelayEnabled = privateRelayEnabled
        lastPrivateRelayDomain = privateRelayDomain
        lastPrivateRelayToken = privateRelayToken
        ...
        Thread({
            ...
            try {
                ...
                NativeProxy.setPrivateRelayConfig(
                    privateRelayEnabled,
                    privateRelayDomain,
                    privateRelayToken
                )
    ...
    private fun restartProxy() {
        ...
        restartJob = serviceScope.launch {
            ...
            startProxy(
                ...
                privateRelayEnabled = lastPrivateRelayEnabled,
                privateRelayDomain = lastPrivateRelayDomain,
                privateRelayToken = lastPrivateRelayToken,
