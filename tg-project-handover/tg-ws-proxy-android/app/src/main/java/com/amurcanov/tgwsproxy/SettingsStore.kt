...
class SettingsStore(private val context: Context) {
    ...
    private object Keys {
        ...
        val PRIVATE_RELAY_ENABLED = booleanPreferencesKey("private_relay_enabled")
        val PRIVATE_RELAY_DOMAIN = stringPreferencesKey("private_relay_domain")
        val PRIVATE_RELAY_TOKEN = stringPreferencesKey("private_relay_token")
    ...
    val privateRelayEnabled: Flow<Boolean> = context.dataStore.data.map { it[Keys.PRIVATE_RELAY_ENABLED] ?: false }
    val privateRelayDomain: Flow<String> = context.dataStore.data.map { it[Keys.PRIVATE_RELAY_DOMAIN] ?: "" }
    val privateRelayToken: Flow<String> = context.dataStore.data.map { it[Keys.PRIVATE_RELAY_TOKEN] ?: "" }
    ...
    suspend fun saveAll(isDcAuto: Boolean, dc1: String, dc2: String, dc3: String, dc4: String, dc5: String, dc203: String,
                        ...
                        privateRelayEnabled: Boolean, privateRelayDomain: String, privateRelayToken: String,
                        secretKey: String) {
        context.dataStore.edit {
            ...
            it[Keys.PRIVATE_RELAY_ENABLED] = privateRelayEnabled
            it[Keys.PRIVATE_RELAY_DOMAIN] = privateRelayDomain
            it[Keys.PRIVATE_RELAY_TOKEN] = privateRelayToken
